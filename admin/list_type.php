...
<table class="table table-bordered table-striped">
    <thead class="table-dark">
        <tr>
            ...
            $base_url = "?ss_type=" . urlencode($ss_type) . "&search=" . urlencode($search) . "&gender_filter=" . urlencode($gender_filter) . "&enroll_filter=" . urlencode($enroll_filter) . "&course_filter=" . urlencode($course_filter) . "&campus_filter=" . urlencode($campus_filter) . "&college_filter=" . urlencode($college_filter) . "&year_filter=" . urlencode($year_filter);
            ?>
            ...
            <th><a href="<?php echo $base_url; ?>&sort=ss_master.ss_name&order=<?php echo ($order_by == 'ss_master.ss_name') ? $next_order : 'ASC'; ?>" class="text-white text-decoration-none d-block">Scholarship Name</a></th>
            <th>Status</th>
        </tr>
    </thead>
